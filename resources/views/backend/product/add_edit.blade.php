      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active ">{{(request()->is('admin-page/product/add'))?'Thêm':'Sửa'}}</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
			...
			<div class="row mb-2">
				...
				<div class="col-sm-9 input-group">
                    ...
                    <div class="custom-file">
                        <input type="file" name="images[]" class="custom-file-input" id="exampleInputFile"accept="image/png, image/jpeg" multiple {{(!isset($product->images)) ?'required':'' }}>
