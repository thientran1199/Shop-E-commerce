...
<body class="hold-transition register-page">
    ...
    <div class="card card-outline card-primary">
        ...
        <form action="" method="post">
            ...
            <input id="stringUsername" type="text" name="stringUsername" placeholder="Username"  class="form-control" required>
            ...
            <div class="input-group mb-3">
            <input id="stringPassword" type="password" name="stringPassword" class="form-control" placeholder="Password" required>
            <div class="input-group-append">
                <div class="input-group-text">
            ...
            <div class="input-group mb-3">
                <input id="stringRePassword" type="password" name="stringRePassword" class="form-control" placeholder="Retype password" required>
                <div class="input-group-append">
                    <div class="input-group-text">
                    <span class="fas fa-lock"></span>
                    </div>
