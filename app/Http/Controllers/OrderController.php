...
class OrderController extends Controller
{
	...
	public function getAdd(){
		...
		return view('frontend.order',compact('slides'),['listCustomerShippingAddress'=>$listCustomerShippingAddress]);
	}
    ...
    public function getOrderHistory(){
    	...
    	return view('frontend.customer.order_history.list',compact('slides'),['listOrder'=>$listOrder]);
    }
    /*chỉ tiết đơn*/
    public function getDetailOrder($id){
        $slides = Slide::all();
    	$order = Order::find($id);
    	return view('frontend.customer.order_history.detail',compact('slides'),['order'=>$order ]);
    }
