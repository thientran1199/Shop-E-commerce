...
class ProductController extends Controller
{
    ...
    public function getListProduct(Request $request){
        ...
        $listProduct = $query->where('enabled',1)->paginate(6);
        return view('frontend.product',['listProduct'=>$listProduct,'slides'=>$slides]);
    }
    public function getDetailProduct($id){
        ...
        $product_detail->save();
        return view('frontend.product_detail',compact('slides','listLatest'),['product_detail'=>$product_detail,'listReview'=>$listReview]);
    }
